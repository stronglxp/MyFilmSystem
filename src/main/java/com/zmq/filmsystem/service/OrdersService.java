...
public interface OrdersService {
     ...
     * @return
     */
    List<Map<String, Object>> getCanemaOrderList(Integer canemaId, Integer toPageNo, Integer pageSize);
     ...
     * @return
     */
    List<Map<String, Object>> getCustomerOrderList(Integer userId, Integer toPageNo, Integer pageSize);
